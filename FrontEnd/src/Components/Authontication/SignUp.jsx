  ...
  return (
    <>
      <>
        ...
        <div
          className="w-screen h-screen pl-36 bg-pink-950 grid items-center bg-no-repeat bg-cover"
          // style={{
        ...
        >
          ...
          >
            ...
            <div className="flex mt-6 w-full gap-5">
              <button
                type="submit"
                className=" text-white rounded-smbg-pink-900text-white transition duration-300 w-full text-sm  py-2 font-semibold tracking-wider bg-pink-900  cursor-pointer"
              >
                SIGN UP
              </button>
            </div>
        ...
        {alert && apiError && (
          <div className="absolute flex justify-center items-center w-screen transition-transform transform translate-y-full">
            <div className="px-7 w-11/12 sm:w-3/4 lg:w-2/4 rounded-md py-2 bg-red-600 flex items-center justify-center text-center">
              <h2 className="text-xl text-white font-thin tracking-widest">
                {apiError}
              </h2>
            </div>
        ...
        <div className="w-screen h-screen bg-pink-950 flex items-center justify-center bg-no-repeat bg-cover">
          <form
            onSubmit={handleSubmit(onSubmit)}
            className="flex justify-center items-center p-4 sm:p-8 bg-white rounded-tl-none rounded-bl-none shadow-xl rounded-3xl flex-col w-11/12 sm:w-3/4 lg:w-2/4"
          >
            <div className="text-start w-full">
              <h2 className="text-black text-start text-2xl sm:text-3xl font-bold">
                CREATE AN <br /> ACCOUNT
              </h2>
            </div>
            ...
            <div className="flex mt-6 w-full gap-3">
              <button
                type="submit"
                className="text-white rounded-sm bg-pink-900 transition duration-300 w-full text-sm py-2 font-semibold tracking-wider cursor-pointer"
              >
                SIGN UP
              </button>
            </div>
            <div className="flex items-center mt-7 gap-3">
              <hr className="bg-blue-900 w-24 sm:w-32" />
              OR
              <hr className="bg-blue-900 w-24 sm:w-32" />
            </div>
            <div
